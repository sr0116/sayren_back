...
public interface PaymentMapper {
  ...
  @Mapping(source = "orderItem.product", target = "productImageUrl", qualifiedByName = "mapProductMainImageUrl")
  ...
  @Mapping(source = "subscribeRound.payStatus", target = "subscribeRoundStatus")
  @Mapping(source = "subscribeRound.dueDate", target = "dueDate")
  @Mapping(source = "subscribeRound.paidDate", target = "paidDate")

  // 회원 (관리자 전용)
  @Mapping(source = "member.name", target = "buyerName")
  @Mapping(source = "member.email", target = "buyerEmail")
  @Mapping(source = "member.tel", target = "buyerTel")
  // 환불 상태 (서비스에서 세팅)
