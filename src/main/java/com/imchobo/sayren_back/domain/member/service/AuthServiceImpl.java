...
public class AuthServiceImpl implements AuthService {
  ...
  // 환경별로 바뀌는 OAuth 시작 URL (local / prod)
  @Value("${app.oauth.base-url}")
  ...
  public String socialLinkRedirectUrl(String provider) {
    ...
    // 예: http://localhost:8080/oauth2/authorization/kakao?state=...
    //   또는 https://api.sayren.imchobo.com/oauth2/authorization/kakao?state=...
    return oauthBaseUrl + "/oauth2/authorization/" + provider.toLowerCase() + "?state=" + state;
  }
