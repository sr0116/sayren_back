...
public class MailService {
  ...
  public void emailVerification(EmailVerifyRequestDTO emailVerifyRequestDTO) {
    ...
    // 예: http://localhost:8080/api/auth/email-verify/{token}
    //   또는 https://api.sayren.imchobo.com/api/auth/email-verify/{token}
    String verificationUrl = backendBaseUrl + "/api/auth/email-verify/" + token;
  ...
  public void passwordResetEmail(String email, Long memberId) {
    ...
    // 예: http://localhost:8080/api/user/member/reset-pw/{token}
    //   또는 https://api.sayren.imchobo.com/api/user/member/reset-pw/{token}
    String verificationUrl = backendBaseUrl + "/api/user/member/reset-pw/" + token;
  ...
  private String buildLogo() {
    ...
    String homeUrl = frontendBaseUrl;

    return "<a href=\"" + homeUrl + "\" class=\"logo\" style=\"display:block;\">"
